          ...
          {!token ? (
            ...
            <>
              ...
              <View style={styles.featuresContainer}>
                ...
                <View style={styles.featureRow}>
                  <TouchableOpacity style={[styles.featureButton, { justifyContent: 'center' }]} onPress={() => navigation.navigate('ChatBot')}>
                    <FontAwesome name="comments" size={30} color="#fff" />
                    <Text style={styles.buttonText}>🤖 ChatBot</Text>
                  </TouchableOpacity>
                  <TouchableOpacity style={[styles.featureButton, { justifyContent: 'center' }]} onPress={() => navigation.navigate('VideoTutorials')}>
